...
export default function Header() {
	let count=useContext(getCart)
	const {arrlength}=count
  return (
    <header id="header">
					...
					<div className="col-sm-8">
						<div className="shop-menu pull-right">
							<ul className="nav navbar-nav">
								...
								<li><a href="cart.html"><i className="fa fa-shopping-cart"></i> Cart {arrlength.length>0 ? <span>({arrlength.length})</span> : ""}</a></li>
